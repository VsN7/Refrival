 ...
 * @author vitor
 */
public class ListagemContaPagamentoView extends javax.swing.JInternalFrame {

    private ContaController cc;
    private int index;
    
    public ListagemContaPagamentoView() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listagem de Titulos por Situação");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${valorPagar}"));
        columnBinding.setColumnName("Valor à Pagar");
        columnBinding.setColumnClass(Double.class);
        columnBinding.setEditable(false);
        ...
        columnBinding.setColumnName("Data da Compra");
        columnBinding.setColumnClass(java.util.Date.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${dataVencimento.time}"));
        columnBinding.setColumnName("Vencimento Prox. Parccela");
        columnBinding.setColumnClass(java.util.Date.class);
        columnBinding.setEditable(false);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione a situação do titulo", "Abertos", "Fechados", "Proximo ao vencimento" }));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if(jComboBox1.getSelectedIndex() != 0){
          ...
          if(index == 3){
              ...
              Date dt = new Date();
              cl.setTime(dt);
              int mesA= Integer.parseInt(df.format(cl.getTime()));
              cc.buscarContaMesP(mesA+1);
          }else{
              cc.buscarContaIndex(index);
          }
       }
